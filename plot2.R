...
# "1/2/2007" and "2/2/2007" were kept. The relevant data is stored in
# "datafile.txt" and is only about 180 KB in size (2880 lines excluding the
# header). This means it can be easily uploaded to GitHub and used to test the
# functionality of the code —- including reading of the data into R.
...
plot(dataframe$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xlab = '', xaxt = 'n')
axis(side = 1, labels = c("Thu", "Fri", "Sat"), at = c(1, 1440, 2880))
dev.off()

# This gives the appropriate (exact) range values for the labels:
#
# rownames(dataframe[dataframe$Date == "2007-02-01 00:00:00",])
# 1
# rownames(dataframe[dataframe$Date == "2007-02-01 23:59:00",])
# 1440
# rownames(dataframe[dataframe$Date == "2007-02-02 23:59:00",])
# 2880
# Etc.
