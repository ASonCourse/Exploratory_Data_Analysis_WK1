...
par(mfrow = c(2,2))
# Plot Upper Left:
plot(dataframe$Global_active_power, type = "l", ylab = "Global Active Power", xlab = '', xaxt = 'n')
axis(side = 1, labels = c("Thu", "Fri", "Sat"), at = c(1, 1440, 2880))
# Plot Upper Right:
plot(dataframe$Voltage, type = "l", ylab = "Voltage", xlab = 'datetime', xaxt = 'n')
axis(side = 1, labels = c("Thu", "Fri", "Sat"), at = c(1, 1440, 2880))
# Plot Lower Left:
...
legend("topright", c('Sub_metering_1', 'Sub_metering_2', 'Sub_metering_3'), box.lwd = '', lwd = 1, col = c('black', 'red', 'blue'))
axis(side = 1, labels = c("Thu", "Fri", "Sat"), at = c(1, 1440, 2880))
# Plot Lower Right:
plot(dataframe$Global_reactive_power, type = 'l', ylab = "Global_reactive_power", xlab = 'datetime', xaxt = 'n')
axis(side = 1, labels = c("Thu", "Fri", "Sat"), at = c(1, 1440, 2880))
dev.off()
